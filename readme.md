...
`<3 partners.library>` = binary file od library of partner motifs. The file name must contain one of the following substrings: "h12core_hg38" , "h12core_mm10" , "h11core_hg38" , "h11core_mm10" , "dapseq". These values respect to the libraries of motifs for human/murine TFs derived from _in vivo_ and _in vitro_ data from [Hocomoco version 12](http://hocomoco12.autosome.ru/) (1400/1100) and [Hocomoco version 11](https://hocomoco11.autosome.org/) (401/346) ([Vorontsov et al., 2024](https://doi.org/10.1093/nar/gkad1077), [Kulakovskiy et al., 2018](https://doi.org/10.1093/nar/gkx1106)); and the library of motifs derived from DAP-seq data [Plant Cistrome](http://neomorph.salk.edu/dap_web/pages/index.php) collection of 510 motifs for *A.thaliana* TFs ([O’Malley et al., 2016](https://doi.org/10.1016/j.cell.2016.08.063)). See lists of motifs for five libraries [here](https://github.com/parthian-sterlet/mcot-kernel/blob/master/include/pfm_list.h) Each ninary file contains the position frequency matrices (PFM), position weight matrices (PWM), and the table "Thresholds vs ERRs for partner motifs for various ERRs are preliminary computed in binary files, see [include](https://github.com/parthian-sterlet/mcot-kernel/blob/master/include/) folder, e.g. [h11core_hg38.binary](https://github.com/parthian-sterlet/mcot-kernel/blob/master/include/h11core_hg38.binary). The lists of matrices for all libraries (PFM/PWM, position frequency/weight matrices), lists of thresholds and ERRs for all matrices, and notations about whether each matrix is taken or rejected by the [MCOT filter]((https://doi.org/10.1093/nar/gkz800) are in [summary XLSX file](https://github.com/parthian-sterlet/mcot-kernel/blob/master/partners/MCOT_dec2023_motifs_libraries.xlsx). Original lists of PFMs from [Hocomoco12](https://hocomoco12.autosome.org/)/[Hocomoco11](https://hocomoco11.autosome.org/) and [Plant Cistrome](http://neomorph.salk.edu/dap_web/pages/index.php) and corresponding PWMs are [here](https://github.com/parthian-sterlet/mcot-kernel/blob/master/partners/MCOT_dec2023_pcm_pwm.tar.gz)
