...
int main(int argc, char *argv[])
{
	...
	if (argc != 6)
	{
		printf("%s 1file_input_hist 2file_input_CEs 3file out_sta 4file out_mat_anc 5file out_mat_par", argv[0]);// f f 9 2 10 5 5
		return -1;
	}
	...
	int rev;
	if (strcmp(ori_best, "DirectAP") == 0 || strcmp(ori_best, "Inverted") == 0)rev = 0;
	else rev = 1;
	{
	}
